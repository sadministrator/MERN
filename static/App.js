...
var issues = [{
  ...
  id: 2, status: 'Assigned', owner: 'Eddie', created: new Date('2016-08-15'), effort: 14, completionDate: new Date('2016-08-30'), title: 'Missing bottom border on panel'
}];
  ...
  _createClass(IssueFilter, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        null,
        'This is a placeholder for the IssueFilter'
      );
    }
  }]);
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'td',
          null,
          issue.completionDate ? issue.completionDate.toDateString() : 'Pending'
        ),
        React.createElement(
          'td',
          null,
  ...
  _createClass(IssueAdd, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        null,
        'This is a placeholder for the IssueAdd'
      );
    }
  }]);
